...
namespace Egnyte.Api.Tests.Links
{
    ...
    public class ListLinksV2Tests
    {
        ...
        public async Task ListLinksV2_ReturnsSuccess()
        {
            ...
            Assert.AreEqual(new DateTime(2016, 01, 28, 6, 01, 17, DateTimeKind.Utc), firstLink.CreationDate.ToUniversalTime());
            ...
            Assert.AreEqual(new DateTime(2016, 01, 28, 6, 01, 17, DateTimeKind.Utc), secondLink.CreationDate.ToUniversalTime());
            Assert.AreEqual("mik", secondLink.CreatedBy);
            Assert.AreEqual(new DateTime(2020, 01, 28, 6, 01, 17, DateTimeKind.Utc), secondLink.ExpiryDate.ToUniversalTime());
